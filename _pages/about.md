...
------
  - CO2PIP postdoctoral fellow
    ...
    - Research projects:
        ...
        2. Developing a multi-proxy system model based on soil carbonate isotopes ($$\delta^{13}\text{C}$$, $$\delta^{18}\text{O}$$, $$\Delta{\prime 17}\text{O}$$) and applying it for paleoenvironmental reconstructions
