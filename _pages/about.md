...
------
  - CO2PIP postdoctoral fellow
    ...
    - Research projects:
        ...
        2. Developing a multi-proxy system model based on soil carbonate isotopes ($\delta^{13}$C, $$\delta^{18}$$O, and  $\Delta{'17}$O) and applying it for paleoenvironmental reconstructions
